...
class TechnicalSupportAgent:
    ...
    def handle_feedback(self, feedback: str) -> Dict[str, Any]:
        ...
        if feedback in ['1', '2', '3', '4', '5']:
            return {
                'response': f"Thank you for your feedback! You rated our service as {feedback}. Have a great day!"
            }
        else:
            return {
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if any(phrase in user_message for phrase in ["thank you", "goodbye", "thanks", "exit", "bye"]):
            ...
            print("Bot: ", response.get('response', 'I am unable to process your request at the moment.'))
